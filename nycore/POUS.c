void MY_PROGRAM_init__(MY_PROGRAM *data__, BOOL retain) {
  ...
  __INIT_LOCATED_VALUE(data__->BUTTON,0)
  __INIT_LOCATED(BOOL,__QX0_0,data__->LAMP,retain)
  __INIT_LOCATED_VALUE(data__->LAMP,1)
  TOF_init__(&data__->T0,retain);
  __INIT_LOCATED(INT,__MW0,data__->VAR1,retain)
  __INIT_LOCATED_VALUE(data__->VAR1,13)
  __INIT_LOCATED(INT,__MW1,data__->VAR2,retain)
  __INIT_LOCATED_VALUE(data__->VAR2,56)
}
